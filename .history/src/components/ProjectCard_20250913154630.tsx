...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      <DeleteConfirmationModal isOpen={isDelete} onClose={() => setIsDelete(false)} description='Are you sure deleting this project? This will delete all the tasks belong to it.' onConfirm={handleDe} />
    </Card>
  );
}