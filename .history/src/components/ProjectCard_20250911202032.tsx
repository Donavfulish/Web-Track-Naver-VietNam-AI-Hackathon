...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="rounded-2xl shadow-md hover:shadow-lg transition-shadow cursor-pointer" onClick={handleClick}>
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex items-center gap-8 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">{new Date(project.finalDeadline).toLocaleDateString()}</span>
              </div>
            </div>
