          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Tiến độ: NewProjectModal.tsx:44 Failed to add project: 
{code: 'PGRST204', details: null, hint: null, message: "Could not find the 'finalDeadline' column of 'projects' in the schema cache"}
code
: 
"PGRST204"
details
...
message
: 
"Could not find the 'finalDeadline' column of 'projects' in the schema cache"
[[Prototype]]
: 
Object </span>
