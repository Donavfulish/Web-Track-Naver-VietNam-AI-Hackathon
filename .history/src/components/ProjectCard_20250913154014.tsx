...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  const deleteProject = useProjectStore((state) => state.)
  const handleClick = () => {
  ...
  return (
    ...
    >
      ...
      <DeleteConfirmationModal isOpen={isDelete} onClose={() => setIsDelete(false)} description='Are you sure deleting this project? This will delete all the tasks belong to it.' onConfirm={() => {console.log('d')}} />
    </Card>
  );
}