...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card
      className="rounded-2xl shadow-md hover:shadow-2xl hover:scale-101 transition-transform transition-shadow duration-300 cursor-pointer"
      onClick={handleClick}
    >
          ...
          <div className="flex-1 space-y-4">
            <div className="flex justify-between items-start">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation()
                    setSelectedProject({ id: "1", name: "Demo", description: "Desc", final_deadline: "2025-09-15", img_src: "..." });
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-gray-300 rounded-full h-3 overflow-hidden">
                <div
                  className="h-3 bg-gradient-to-r from-blue-500 to-green-400 rounded-full transition-all duration-500"
      ...
      <DeleteConfirmationModal isOpen={isDelete} onClose={() => setIsDelete(false)} description='Are you sure deleting this project? This will delete all the tasks belong to it.' onConfirm={handleDelete} />
    </Card>
  );
}