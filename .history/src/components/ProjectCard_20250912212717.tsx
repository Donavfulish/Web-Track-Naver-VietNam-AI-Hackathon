...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card
      className="rounded-2xl shadow-md hover:shadow-2xl hover:scale-101 hover:bg-gray-250 transition-transform transition-shadow transition-colors duration-300 cursor-pointer"
      onClick={handleClick}
    >
