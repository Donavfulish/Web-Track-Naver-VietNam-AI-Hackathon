...
interface ProjectState {
    ...
    addProject: (newProjectData: Omit<Project, 'id' | 'created_at' | 'progress' | 'num_pending' | 'num_done' | 'num_to_do' | 'progress'>) => Promise<Project>;
    ...
    fetchProjects: async () => {
        ...
        try {
            const {data, error} = await supabase
                .from('projects')
                .select('*, created_at AT TIME ZONE 'UTC' AT TIME ZONE 'Asia/Ho_Chi_Minh'");
